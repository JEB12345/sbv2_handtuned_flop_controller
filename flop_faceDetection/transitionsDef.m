...
transition{1,2} = [5    3   11  1   8];
transition{1,8} = [10   16  18  14 	11];
transition{1,6} = [19   21  8   23  18];

transition{2,3} = [12   14  22  16  9];
transition{2,7} = [23   17  7 	19  22];
transition{2,1} = [6    4   9 	2   7];

transition{3,4} = [21   19  3   17  24];
transition{3,8} = [2    8 	10 	6 	3];
transition{3,2} = [11   13  24 	15 	10];

transition{4,5} = [4    6   14  8   1];
transition{4,7} = [15   9 	23 	11 	14];
transition{4,3} = [22   20 	1 	18 	23];

transition{5,6} = [13   11  19  9   16];
transition{5,8} = [18   24 	2 	22 	19];
transition{5,4} = [3    5 	16 	7 	2];

transition{6,1} = [20   22  6   24  17];
transition{6,7} = [7    1 	15 	3 	6];
transition{6,5} = [14   12  17 	10 	15];

transition{7,6} = [8    2 	13 	4 	5];
transition{7,4} = [16   10 	21 	12 	13];
transition{7,2} = [24   18 	5 	20 	21];

transition{8,5} = [17   23 	4 	21 	20];
transition{8,3} = [1    7 	12 	5 	4];
